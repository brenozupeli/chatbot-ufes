...
var ConversationPanel = (function() {
    ...
    function chatUpdateSetup() {
        ...
        Api.setResponsePayload = function(newPayloadStr) {
			...
			var aditionalTime = JSON.parse(newPayloadStr).output.text[0] ? JSON.parse(newPayloadStr).output.text[0].length * 10 : 0;
                showTypingGif(false);
...
// Set up the input box to underline text as it is typed
    ...
    function setupInputBox() {
        ...
        function adjustInput() {
            if (input.value === '') {
                ...
                var widthValue = ( dummy.offsetWidth + padding + 6) + 'px';
    ...
    function showTypingGif(visible){
        if (visible){
